...
var MAX_BINS_PER_POSITION = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _26 => _26.find, 'call', _27 => _27(([_, v]) => v.name == "POSITION_MAX_LENGTH"), 'optionalAccess', _28 => _28[1], 'access', _29 => _29.value]), () => ( 0))
);
var MAX_BIN_PER_LIMIT_ORDER = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _30 => _30.find, 'call', _31 => _31(([_, v]) => v.name == "MAX_BIN_PER_LIMIT_ORDER"), 'optionalAccess', _32 => _32[1], 'access', _33 => _33.value]), () => ( 0))
);
var LIMIT_ORDER_FEE_SHARE = new (0, _anchor.BN)(
  _nullishCoalesce(_optionalChain([CONSTANTS, 'access', _34 => _34.find, 'call', _35 => _35(([_, v]) => v.name == "LIMIT_ORDER_FEE_SHARE"), 'optionalAccess', _36 => _36[1], 'access', _37 => _37.value]), () => ( 0))
);
...
var DLMMError = class extends Error {
  ...
  constructor(error) {
    ...
    if (error instanceof Error) {
      ...
      if (_optionalChain([anchorError, 'optionalAccess', _38 => _38.program, 'access', _39 => _39.toBase58, 'call', _40 => _40()]) === LBCLMM_PROGRAM_IDS["mainnet-beta"]) {
...
var getSimulationComputeUnits = async (connection, instructions, payer, lookupTables, commitment = "confirmed") => {
  ...
  if (_optionalChain([rpcResponse, 'optionalAccess', _41 => _41.value, 'optionalAccess', _42 => _42.err])) {
    const logs = _optionalChain([rpcResponse, 'access', _43 => _43.value, 'access', _44 => _44.logs, 'optionalAccess', _45 => _45.join, 'call', _46 => _46("\n  \u2022 ")]) || "No logs available";
    throw new Error(
      `Transaction simulation failed:
  \u2022${logs}` + JSON.stringify(_optionalChain([rpcResponse, 'optionalAccess', _47 => _47.value, 'optionalAccess', _48 => _48.err]))
    );
  }
...
var parseLogs = (eventParser, logs) => {
  ...
  for (const event of _optionalChain([eventParser, 'optionalAccess', _49 => _49.parseLogs, 'call', _50 => _50(logs)])) {
    return event.data;
  }
...
function createProgram(connection, opt) {
  ...
  return new (0, _anchor.Program)(
    { ...idl_default, address: _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _52 => _52.programId]), () => ( LBCLMM_PROGRAM_IDS[cluster])) },
    provider
  );
}
...
function getAccountDiscriminator(accountName) {
  return _optionalChain([idl_default, 'access', _53 => _53.accounts, 'access', _54 => _54.find, 'call', _55 => _55(
    (acc) => acc.name.toLowerCase() === accountName.toLowerCase()
  ), 'optionalAccess', _56 => _56.discriminator]);
}
...
var DLMM = class {
  ...
  static async create(connection, dlmm, opt) {
    ...
    const lbPairAccountInfoBuffer = _optionalChain([accountsInfo, 'access', _57 => _57[0], 'optionalAccess', _58 => _58.data]);
    ...
    const binArrayBitMapAccountInfoBuffer = _optionalChain([accountsInfo, 'access', _59 => _59[1], 'optionalAccess', _60 => _60.data]);
    ...
    const clockAccountInfoBuffer = _optionalChain([accountsInfo, 'access', _61 => _61[2], 'optionalAccess', _62 => _62.data]);
  ...
  static async createMultiple(connection, dlmmList, opt) {
    ...
    const clockAccountInfoBuffer = _optionalChain([clockAccount, 'optionalAccess', _63 => _63.data]);
    if (!clockAccountInfoBuffer)
      throw new Error(`Clock account not found`);
    const clock = ClockLayout.decode(clockAccountInfoBuffer);
    ...
    for (let i = 0; i < dlmmList.length; i++) {
      ...
      const lbPairAccountInfoBuffer = _optionalChain([accountsInfo, 'access', _64 => _64[i], 'optionalAccess', _65 => _65.data]);
      if (!lbPairAccountInfoBuffer)
    ...
    for (let i = dlmmList.length; i < accountsInfo.length; i++) {
      ...
      const binArrayBitMapAccountInfoBuffer = _optionalChain([accountsInfo, 'access', _66 => _66[i], 'optionalAccess', _67 => _67.data]);
      if (binArrayBitMapAccountInfoBuffer) {
  ...
  static async getAllLbPairPositionsByUser(connection, userPubKey, opt, getPositionsOpt) {
    ...
    const positionsV2 = await chunkedGetProgramAccounts(
      ...
      _optionalChain([getPositionsOpt, 'optionalAccess', _68 => _68.chunkSize]),
      _optionalChain([getPositionsOpt, 'optionalAccess', _69 => _69.onChunkFetched]),
      _optionalChain([getPositionsOpt, 'optionalAccess', _70 => _70.isParallelExecution])
    );
    ...
    for (const position of positionWrappers) {
      ...
      const reserveXBalance = _nullishCoalesce(_optionalChain([lbPairReserveMap, 'access', _71 => _71.get, 'call', _72 => _72(lbPair.toBase58()), 'optionalAccess', _73 => _73.reserveX]), () => ( BigInt(0)));
      const reserveYBalance = _nullishCoalesce(_optionalChain([lbPairReserveMap, 'access', _74 => _74.get, 'call', _75 => _75(lbPair.toBase58()), 'optionalAccess', _76 => _76.reserveY]), () => ( BigInt(0)));
      ...
      if (positionData) {
        positionsMap.set(lbPair.toBase58(), {
          ...
          tokenY,
          lbPairPositionsData: [
            ..._nullishCoalesce(_optionalChain([positionsMap, 'access', _77 => _77.get, 'call', _78 => _78(lbPair.toBase58()), 'optionalAccess', _79 => _79.lbPairPositionsData]), () => ( [])),
            {
  ...
  async getLbPairLockInfo(lockDurationOpt, getPositionsOpt) {
    ...
    const positionAccounts = await chunkedGetProgramAccounts(
      ...
      _optionalChain([getPositionsOpt, 'optionalAccess', _80 => _80.chunkSize]),
      _optionalChain([getPositionsOpt, 'optionalAccess', _81 => _81.onChunkFetched]),
      _optionalChain([getPositionsOpt, 'optionalAccess', _82 => _82.isParallelExecution])
    );
  ...
  static async createCustomizablePermissionlessLbPair2(connection, binStep, tokenX, tokenY, activeId, feeBps, activationType, hasAlphaVault, creatorKey, activationPoint, creatorPoolOnOffControl, concreteFunctionType, collectFeeMode, opt) {
    ...
    if ((tokenX.equals(_spltoken.NATIVE_MINT) || tokenY.equals(_spltoken.NATIVE_MINT)) && !_optionalChain([opt, 'optionalAccess', _83 => _83.skipSolWrappingOperation])) {
  ...
  static async createCustomizablePermissionlessLbPair(connection, binStep, tokenX, tokenY, activeId, feeBps, activationType, hasAlphaVault, creatorKey, activationPoint, creatorPoolOnOffControl, concreteFunctionType, collectFeeMode, opt) {
    ...
    preInstructions.push(createUserTokenYIx);
    const postInstructions = [];
    if ((tokenX.equals(_spltoken.NATIVE_MINT) || tokenY.equals(_spltoken.NATIVE_MINT)) && !_optionalChain([opt, 'optionalAccess', _84 => _84.skipSolWrappingOperation])) {
      const wrapAmount = BigInt(1);
      if (tokenX.equals(_spltoken.NATIVE_MINT)) {
        const wrapSOLIxX = wrapSOLInstruction(
          creatorKey,
  ...
  static async createLbPair2(connection, funder, tokenX, tokenY, presetParameter, activeId, opt) {
    ...
    const existsPool = await this.getPairPubkeyIfExists(
      ...
      {
        cluster: _optionalChain([opt, 'optionalAccess', _85 => _85.cluster]),
        programId: _optionalChain([opt, 'optionalAccess', _86 => _86.programId])
      }
    );
    if (existsPool) {
      throw new Error("Pool already exists");
  ...
  async getPositionsByUserAndLbPair(userPubKey, getPositionsOpt) {
    const promiseResults = await Promise.all([
      ...
      userPubKey && chunkedGetProgramAccounts(
        ...
        _optionalChain([getPositionsOpt, 'optionalAccess', _89 => _89.chunkSize]),
        _optionalChain([getPositionsOpt, 'optionalAccess', _90 => _90.onChunkFetched]),
        _optionalChain([getPositionsOpt, 'optionalAccess', _91 => _91.isParallelExecution])
      )
    ]);
      ...
      positions.map(async (position) => {
        return {
          ...
          positionData: await DLMM.processPosition(
            ...
            this.tokenX.mint,
            this.tokenY.mint,
            _optionalChain([this, 'access', _92 => _92.rewards, 'access', _93 => _93[0], 'optionalAccess', _94 => _94.mint]),
            _optionalChain([this, 'access', _95 => _95.rewards, 'access', _96 => _96[1], 'optionalAccess', _97 => _97.mint]),
            positionBinArraysMapV2
          ),
  ...
  async getPosition(positionPubKey) {
    ...
    return {
      ...
      positionData: await DLMM.processPosition(
        ...
        this.tokenX.mint,
        this.tokenY.mint,
        _optionalChain([this, 'access', _98 => _98.rewards, 'access', _99 => _99[0], 'optionalAccess', _100 => _100.mint]),
        _optionalChain([this, 'access', _101 => _101.rewards, 'access', _102 => _102[1], 'optionalAccess', _103 => _103.mint]),
        binArrayMap
      ),
      version: position.version()
    };
  ...
  async initializeMultiplePositionAndAddLiquidityByStrategy2(positionKeypairGenerator, totalXAmount, totalYAmount, strategy, owner, payer, slippagePercentage, altAddress) {
    ...
    const defaultAltAddressString = _nullishCoalesce(altAddress, () => ( ALT_ADDRESS[_optionalChain([this, 'access', _104 => _104.opt, 'optionalAccess', _105 => _105.cluster])]));
  ...
  async initializePositionAndAddLiquidityByStrategy({
    ...
    if (this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) && !totalXAmount.isZero() && !_optionalChain([this, 'access', _112 => _112.opt, 'optionalAccess', _113 => _113.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenX,
        BigInt(totalXAmount.toString())
    ...
    if (this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT) && !totalYAmount.isZero() && !_optionalChain([this, 'access', _114 => _114.opt, 'optionalAccess', _115 => _115.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenY,
        BigInt(totalYAmount.toString())
    ...
    ].includes(_spltoken.NATIVE_MINT.toBase58()) && !_optionalChain([this, 'access', _116 => _116.opt, 'optionalAccess', _117 => _117.skipSolWrappingOperation])) {
  ...
  async initializePositionAndAddLiquidityByWeight({
    ...
    createPayerTokenXIx && preInstructions.push(createPayerTokenXIx);
    createPayerTokenYIx && preInstructions.push(createPayerTokenYIx);
    if (this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) && !totalXAmount.isZero() && !_optionalChain([this, 'access', _118 => _118.opt, 'optionalAccess', _119 => _119.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenX,
        BigInt(totalXAmount.toString())
    ...
    if (this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT) && !totalYAmount.isZero() && !_optionalChain([this, 'access', _120 => _120.opt, 'optionalAccess', _121 => _121.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenY,
        BigInt(totalYAmount.toString())
    ...
    if ([
      this.tokenX.publicKey.toBase58(),
      this.tokenY.publicKey.toBase58()
    ].includes(_spltoken.NATIVE_MINT.toBase58()) && !_optionalChain([this, 'access', _122 => _122.opt, 'optionalAccess', _123 => _123.skipSolWrappingOperation])) {
      const closeWrappedSOLIx = await unwrapSOLInstruction(user);
      closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
    }
  ...
  async addLiquidityByStrategy({
    ...
    createPayerTokenXIx && preInstructions.push(createPayerTokenXIx);
    createPayerTokenYIx && preInstructions.push(createPayerTokenYIx);
    if (this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) && !totalXAmount.isZero() && !_optionalChain([this, 'access', _124 => _124.opt, 'optionalAccess', _125 => _125.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenX,
        BigInt(totalXAmount.toString())
    ...
    if (this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT) && !totalYAmount.isZero() && !_optionalChain([this, 'access', _126 => _126.opt, 'optionalAccess', _127 => _127.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenY,
        BigInt(totalYAmount.toString())
    ...
    if ([
      this.tokenX.publicKey.toBase58(),
      this.tokenY.publicKey.toBase58()
    ].includes(_spltoken.NATIVE_MINT.toBase58()) && !_optionalChain([this, 'access', _128 => _128.opt, 'optionalAccess', _129 => _129.skipSolWrappingOperation])) {
      const closeWrappedSOLIx = await unwrapSOLInstruction(user);
      closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
    }
    const liquidityParams = {
  ...
  async addLiquidityByWeight2({
    ...
    for (const { lowerBinId: lowerBinId2, upperBinId: upperBinId2 } of chunkedBinRange) {
      ...
      preInstructions.push(...createBinArrayIxs);
      if (this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) && !totalChunkedXAmount.isZero() && !_optionalChain([this, 'access', _130 => _130.opt, 'optionalAccess', _131 => _131.skipSolWrappingOperation])) {
        const wrapSOLIx = wrapSOLInstruction(
          user,
          userTokenX,
      ...
      if (this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT) && !totalChunkedYAmount.isZero() && !_optionalChain([this, 'access', _132 => _132.opt, 'optionalAccess', _133 => _133.skipSolWrappingOperation])) {
        const wrapSOLIx = wrapSOLInstruction(
          user,
          userTokenY,
  ...
  async addLiquidityByWeight({
    ...
    createPayerTokenXIx && preInstructions.push(createPayerTokenXIx);
    createPayerTokenYIx && preInstructions.push(createPayerTokenYIx);
    if (this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) && !totalXAmount.isZero() && !_optionalChain([this, 'access', _134 => _134.opt, 'optionalAccess', _135 => _135.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenX,
        BigInt(totalXAmount.toString())
    ...
    if (this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT) && !totalYAmount.isZero() && !_optionalChain([this, 'access', _136 => _136.opt, 'optionalAccess', _137 => _137.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenY,
        BigInt(totalYAmount.toString())
    ...
    if ([
      this.tokenX.publicKey.toBase58(),
      this.tokenY.publicKey.toBase58()
    ].includes(_spltoken.NATIVE_MINT.toBase58()) && !_optionalChain([this, 'access', _138 => _138.opt, 'optionalAccess', _139 => _139.skipSolWrappingOperation])) {
      const closeWrappedSOLIx = await unwrapSOLInstruction(user);
      closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
    }
    const liquidityParams = {
  ...
  async removeLiquidity({
    ...
    for (const { lowerBinId, upperBinId } of chunkedBinRange) {
      ...
      if ([
        this.tokenX.publicKey.toBase58(),
        this.tokenY.publicKey.toBase58()
      ].includes(_spltoken.NATIVE_MINT.toBase58()) && (!skipUnwrapSOL || !_optionalChain([this, 'access', _140 => _140.opt, 'optionalAccess', _141 => _141.skipSolWrappingOperation]))) {
        const closeWrappedSOLIx = await unwrapSOLInstruction(user);
        closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
      }
      preInstructions.push(createUserTokenXIx);
  ...
  swapQuoteExactOut(outAmount, swapForY, allowedSlippage, binArrays, maxExtraBinArrays = 0) {
    ...
    while (!outAmountLeft.isZero()) {
      let binArrayAccountToSwap = findNextBinArrayWithLiquidity(
        ...
        activeId,
        this.lbPair,
        _nullishCoalesce(_optionalChain([this, 'access', _142 => _142.binArrayBitmapExtension, 'optionalAccess', _143 => _143.account]), () => ( null)),
        binArrays
      );
    ...
    if (maxExtraBinArrays > 0 && maxExtraBinArrays <= MAX_EXTRA_BIN_ARRAYS) {
      ...
      while (extraBinArrays.length < maxExtraBinArrays) {
        let binArrayAccountToSwap = findNextBinArrayWithLiquidity(
          ...
          activeId,
          this.lbPair,
          _nullishCoalesce(_optionalChain([this, 'access', _144 => _144.binArrayBitmapExtension, 'optionalAccess', _145 => _145.account]), () => ( null)),
          binArrays
        );
        if (binArrayAccountToSwap == null) {
          break;
  ...
  async swapExactOut({
    ...
    if (inToken.equals(_spltoken.NATIVE_MINT) && !_optionalChain([this, 'access', _150 => _150.opt, 'optionalAccess', _151 => _151.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        user,
        userTokenIn,
    ...
    if (outToken.equals(_spltoken.NATIVE_MINT) && !_optionalChain([this, 'access', _152 => _152.opt, 'optionalAccess', _153 => _153.skipSolWrappingOperation])) {
      const closeWrappedSOLIx = await unwrapSOLInstruction(user);
      closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
    }
    const { slices, accounts: transferHookAccounts } = this.getPotentialToken2022IxDataAndAccounts(0 /* Liquidity */);
  ...
  canSyncWithMarketPrice(marketPrice, activeBinId) {
    ...
    const toBinArrayIndex = findNextBinArrayIndexWithLiquidity(
      ...
      this.lbPair,
      _nullishCoalesce(_optionalChain([this, 'access', _162 => _162.binArrayBitmapExtension, 'optionalAccess', _163 => _163.account]), () => ( null))
    );
  ...
  async syncWithMarketPrice(marketPrice, owner) {
    ...
    const toBinArrayIndex = findNextBinArrayIndexWithLiquidity(
      ...
      new (0, _anchor.BN)(activeBinId),
      this.lbPair,
      _nullishCoalesce(_optionalChain([this, 'access', _164 => _164.binArrayBitmapExtension, 'optionalAccess', _165 => _165.account]), () => ( null))
    );
    const marketPriceBinArrayIndex = binIdToBinArrayIndex(
      new (0, _anchor.BN)(marketPriceBinId)
    );
    ...
    if (binArrayBitMapExtensionPubkey) {
      ...
      if (!_optionalChain([binArrayAccounts, 'optionalAccess', _166 => _166[0]])) {
    ...
    if (!!_optionalChain([binArrayAccounts, 'optionalAccess', _167 => _167[1]])) {
      fromBinArray = fromBinArrayPubkey;
    }
    if (!!_optionalChain([binArrayAccounts, 'optionalAccess', _168 => _168[2]]) && !!toBinArrayIndex) {
  ...
  async rebalancePosition(rebalancePositionResponse, maxActiveBinSlippage, rentPayer, slippage = 100) {
    ...
    const postInstructions = [];
    if (this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) && simulationResult.actualAmountXDeposited.gtn(0) && !_optionalChain([this, 'access', _169 => _169.opt, 'optionalAccess', _170 => _170.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        owner,
        userTokenX,
    ...
    if (this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT) && simulationResult.actualAmountYDeposited.gtn(0) && !_optionalChain([this, 'access', _171 => _171.opt, 'optionalAccess', _172 => _172.skipSolWrappingOperation])) {
      const wrapSOLIx = wrapSOLInstruction(
        owner,
        userTokenY,
    ...
    if ((this.tokenX.publicKey.equals(_spltoken.NATIVE_MINT) || this.tokenY.publicKey.equals(_spltoken.NATIVE_MINT)) && !_optionalChain([this, 'access', _173 => _173.opt, 'optionalAccess', _174 => _174.skipSolWrappingOperation])) {
  ...
  async placeLimitOrder({
    ...
    if (tokenMint.equals(_spltoken.NATIVE_MINT) && !_optionalChain([this, 'access', _175 => _175.opt, 'optionalAccess', _176 => _176.skipSolWrappingOperation])) {
  ...
  async getBins(lbPairPubKey, lowerBinId, upperBinId, baseTokenDecimal, quoteTokenDecimal, lowerBinArray, upperBinArray) {
    ...
    const version = _nullishCoalesce(_optionalChain([binArrays, 'access', _181 => _181.find, 'call', _182 => _182((binArray) => binArray != null), 'optionalAccess', _183 => _183.version]), () => ( 1));
    return Array.from(
      enumerateBins(
        binsById,
        lowerBinId,
  ...
  async createClaimSwapFeeMethod({
    ...
    for (const {
      ...
      if ([
        this.tokenX.publicKey.toBase58(),
        this.tokenY.publicKey.toBase58()
      ].includes(_spltoken.NATIVE_MINT.toBase58()) && !_optionalChain([this, 'access', _184 => _184.opt, 'optionalAccess', _185 => _185.skipSolWrappingOperation])) {
        const closeWrappedSOLIx = await unwrapSOLInstruction(owner);
        closeWrappedSOLIx && postInstructions.push(closeWrappedSOLIx);
      }
      const { slices, accounts: transferHookAccounts } = this.getPotentialToken2022IxDataAndAccounts(0 /* Liquidity */);
